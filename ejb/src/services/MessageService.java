...
public interface MessageService{
    ...
    /**
     * mark all the messages of the given user of a specific message's groupName as read
     * 
     * @param ue
     * @param groupMessage
     */
    ...
    /**
     * return a MessageDisplayListwhich contain multiple list needed for the display of the message 
     * without the message list of a given groupMessage
     * @param userID
   ...
   // public MessageDisplayList getGListPlusNewListFromUserID(Long userID);
    ...
    /**
     * return a MessageDisplayListwhich contain multiple list needed for the display of the message 
     * with the message list of a given groupMessage
     * @param userID
     * @param groupMessage
     * @return MessageDisplayList
     */
